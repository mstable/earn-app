  ...
  return (
    <Container>
      <Header>
        <Logo />
        <Tagline>
          <EarnLine>Earn</EarnLine>
          <div>Try <ExternalLink href="https://app.mstable.org/#/musd/pools">mStable Pools</ExternalLink> for new opportunities to earn with mStable</div>
        </Tagline>
      </Header>
      <Buttons>
